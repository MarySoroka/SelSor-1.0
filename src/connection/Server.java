...
public class Server {
    private final int STARTINGMONEY = 1500000;
    private final int CARDCOUNT = 9;
    private final int MAX_PLAYER = 4;
    private final String basePath = "/home/maria/Desktop/SelSor/";
    private final String databasePath = "jdbc:sqlite:" + basePath + "src/database/SEPoly.db";
    ...
    public <T> void sendToAllClients(ServerMessage<T> serverMessage) throws IOException {
    ...
    public void startNextPlayerTurn(int playerID) throws IOException {
        ...
        } while (players.get(nextPlayerIDTurn) == null);
        ClientHandler firstPlayerClient = clients.get(nextPlayerIDTurn);
        ServerMessage<String> serverMessage = new ServerMessage<>("startTurn", "");
    ...
    public void updatePlayer(Player player) throws IOException {
        ...
        ServerMessage<PlayerObj> serverMessage = new ServerMessage<>("updateOpponent", playerObj);
    ...
    public void setNewHighestBid(BidObj bidObj) throws IOException {
        ...
        ServerMessage<BidObj> serverMessage = new ServerMessage<>("updateHighestBidPrice", bidObj);
        sendToAllClients(serverMessage);
    }

    public <T> void startAuction(ServerMessage<T> serverMessage) throws IOException {
    ...
    private void sendMapData() throws IOException {
        ServerMessage<ArrayList<Space>> serverMessage = new ServerMessage<>("initMap", map);
        sendToAllClients(serverMessage);
    }

    private void sendStartGame() throws IOException {
        System.out.println("starting!");
        ServerMessage<String> serverMessage = new ServerMessage<String>("startGame", "");
        sendToAllClients(serverMessage);
    }
